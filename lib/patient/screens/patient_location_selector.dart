...
import 'package:flutter_ea_mobile_app/patient/screens/patient_appointment_list.dart';
...
class PatientLocationSelector extends StatefulWidget {
  PatientLocationSelector({this.isBookNow});

  bool isBookNow;

  @override
  _PatientLocationSelectorState createState() =>
      _PatientLocationSelectorState();
}

class _PatientLocationSelectorState extends State<PatientLocationSelector> {
  //COLORS
                                ...
                                child: Row(
                                  children: <Widget>[
                                    ...
                                    Column(
                                      ...
                                      children: <Widget>[
                                        Text(
                                          "${utils.pakistaniCurrency}. ${locationsProvider.locations[index].fee}"
                                              .toString(),
                                          style: TextStyle(
                                              fontSize: _sizes.smallTextSize,
                                              color: _colors.grey,
